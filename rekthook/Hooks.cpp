...
void Hooks::UndoHooks()
{
	...
	Interfaces::EventManager->RemoveListener(DamageListener);
...
void Hooks::Initialise()
{
	...
	// ...In injection thread
	Interfaces::EventManager->AddListener(DamageListener, "player_hurt", false);
	...
	// ...In injection thread
	Interfaces::EventManager->AddListener(KillListener, "player_death", false);


	Resolvertest = new DamageEventListener(testResolver);
	// ...In injection thread
	Interfaces::EventManager->AddListener(Resolvertest, "round_start", false);
	...
	// ...In injection thread
	Interfaces::EventManager->AddListener(round_end, "player_death", false);
		...
		if (Menu::Window.VisualsTab.AAIndicators.GetState())
		{
			...
			if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame())
			{
				if (Menu::Window.RageBotTab.ManualAAEnable.GetState())
				{
					...
					{
						Render::Text(cW + 34, cH - 20, Color(0, 128, 255, 160), Render::Fonts::ESP, L"?");
						Render::Text(cW - 50, cH - 20, Color(255, 255, 255, 160), Render::Fonts::ESP, L"?");
					}
					else
					{
						Render::Text(cW + 34, cH - 20, Color(255, 255, 255, 160), Render::Fonts::ESP, L"?");
						Render::Text(cW - 50, cH - 20, Color(0, 128, 255, 160), Render::Fonts::ESP, L"?");
					}
				}
				else
				{
