...
#pragma region AntiAim
	...
	AntiAimGroup.PlaceLabledControl("Enable manual aa", this, &ManualAAEnable);

	ManualAASwitch.SetFileId("manual_aaswitchkey");
	AntiAimGroup.PlaceLabledControl("Manual switch key", this, &ManualAASwitch);
...
#pragma region Options
	...
	OptionsGroup.PlaceCheckBox("AA indicator", this, &AAIndicators);
